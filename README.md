...
- **Guía completa para clonar, instalar herramientas y levantar el proyecto en local:** [`SETUP_LOCAL_EQUIPO_DESARROLLO.md`](SETUP_LOCAL_EQUIPO_DESARROLLO.md) (incluye verificación paso a paso).
